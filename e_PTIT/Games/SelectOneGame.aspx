<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="SelectOneGame.aspx.cs" Inherits="e_PTIT.Games.SelectOneGame" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="margin-top: 10px !important; width: 100%;" class="text-center">
        ...
        <div class="text-center">
            <img src="../images/logic-games.png" />
        </div>
    </div>
    ...
    <div id="divContent" runat="server" style="padding: 20px; color: yellow;">
        <div class="row">
            <div class="col-md-12">
        ...
        <asp:Repeater ID="rptGames" runat="server" OnItemDataBound="rptGames_ItemDataBound">
            <HeaderTemplate>
                <div class="row" style="padding-left:10%; text-align: center !important;">
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <h2>
                ...
                <div class="row" id="divRow" runat="server"></div>
                <div class="row">
                    <div class="col-md-2">
                        <a id="lnkAns" href="#" runat="server" class="btn btn-info small pink danger"><%= e_PTIT.Constants.SHOW_ANSWER %></a>
                    </div>
                </div>
