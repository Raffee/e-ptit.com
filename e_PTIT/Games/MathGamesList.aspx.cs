...
{
    public partial class MathGamesList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            using (db)
            {
                var gameGroups = db.GameGroups.Where(c => c.fkEditionId == 1 && c.fkGameMenuTypeId == (int)PtitEnums.GameMenuType.Mathematical).ToList();
        ...
        protected void rptGameGroups_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if(e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (grp.fkGameTypeId == (int)PtitEnums.GameType.WriteAnswer)
                {
                    lnkGame.HRef = "WriteAnswerGame.aspx?ID=" + grp.pkGameGroupID;
                    imgIcon.Src = "../images/games/icons/maths.jpg";
                }
            }
        }
    }
