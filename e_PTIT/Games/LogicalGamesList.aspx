<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Site.Master" AutoEventWireup="true" CodeBehind="LogicalGamesList.aspx.cs" Inherits="e_PTIT.Games.LogicalGamesList" %>
                ...
                <a id="lnkGame" runat="server">
                    <div class="dt-sc-titled-box mustard">
                        ...
                        <div class="dt-sc-titled-box-content" style="color: #2a89d8; height: 100px">
                            <div class="col-md-3">
                                <img id="imgIcon" runat="server" style="width: 76px;" /></div>
